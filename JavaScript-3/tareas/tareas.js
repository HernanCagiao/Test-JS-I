...
function incrementarPorUno(array) {
  ...
  // Aumenta ca(da entero por 1
  // y devuelve el array
  // Tu código:
    // array = [3, 25, 59, 95, 74, 27, 153, -124];
...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  let suma = numeros.reduce((totalSuma, numero)=> totalSuma + numero);
  return suma;
}
...
function cuentoElementos(arreglo){
  ...
  const resultado = arreglo.filter(numero => numero > 19);
